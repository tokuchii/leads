      ...
      <div class="relative" :class="[activeTabBg, 'pt-6 rounded-4xl']" style="min-height: 480px;">
        <div class="bg-[#FFFFFF] rounded-4xl p-4 sm:p-8 lg:p-14 text-back shadow-xl" style="min-height: 600px;">
          ...
          <div v-if="activeTab === 'Herbicide' && mangoHerbicideProducts.length" class="space-y-8">
            <div v-for="product in mangoHerbicideProducts" :key="product.id" class="flex flex-col md:flex-row bg-white rounded-3xl overflow-hidden">
          ...
          <div v-if="activeTab === 'Fungicide' && mangoFungicideProducts.length" class="space-y-8">
            <div v-for="product in mangoFungicideProducts" :key="product.id" class="flex flex-col md:flex-row bg-white rounded-3xl overflow-hidden">
              <div class="flex-shrink-0 flex items-center justify-center md:w-1/2 pt-12">
                <img v-if="product.image1_url" :src="product.image1_url" alt="Image 1" class="w-full h-full" />
              </div>
              <div class="flex-1 p-6 md:p-8">
          ...
          <div v-if="activeTab === 'Biostimulant' && mangoBiostimulantProducts.length" class="space-y-8">
            <div v-for="product in mangoBiostimulantProducts" :key="product.id" class="flex flex-col md:flex-row bg-white rounded-3xl overflow-hidden">
              <div class="flex-shrink-0 flex items-center justify-center md:w-1/2 pt-12">
                <img v-if="product.image1_url" :src="product.image1_url" alt="Image 1" class="w-full h-full" />
              </div>
              <div class="flex-1 p-6 md:p-8">
          ...
          <div v-if="activeTab === 'Insecticide' && mangoInsecticideProducts.length" class="space-y-8">
            <div v-for="product in mangoInsecticideProducts" :key="product.id" class="flex flex-col md:flex-row bg-white rounded-3xl overflow-hidden">
              <div class="flex-shrink-0 flex items-center justify-center md:w-1/2 pt-12">
                <img v-if="product.image1_url" :src="product.image1_url" alt="Image 1" class="w-full h-full" />
              </div>
              <div class="flex-1 p-6 md:p-8">
