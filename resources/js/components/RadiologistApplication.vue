        ...
        <div class="w-full max-w-6xl flex flex-col md:flex-row gap-10 items-stretch">
          ...
          <div class="p-8 flex flex-col w-full md:w-1/2 justify-center h-full">
            ...
            <form class="flex flex-col gap-4" @submit.prevent="submitForm">
              ...
              <input type="text" placeholder="Your Position*" value="Radiologist" readonly class="rounded-full bg-[#F4F4F4] shadow-md placeholder:italic px-4 py-3 border border-gray-200 focus:outline-none focus:ring-0 text-black" />
