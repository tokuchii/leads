                    ...
                    <div class="p-8 flex flex-col w-full md:w-1/2 justify-center h-full">
                        ...
                        <form class="flex flex-col gap-4" @submit.prevent="submitForm">
                            ...
                            <textarea placeholder="Enter your message" rows="4" v-model="message"
                                ...
                                class="rounded-2xl bg-[#F4F4F4] placeholder:italic px-4 py-3 border border-gray-200 focus:shadow-md focus:outline-none focus:ring-0 resize-none transition-all duration-200" required></textarea>
                            <div>
    ...
    methods: {
        ...
        async submitForm() {
            ...
            try {
                ...
                formData.append('position', 'Radiologist');
